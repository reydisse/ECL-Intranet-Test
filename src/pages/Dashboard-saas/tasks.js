                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted mb-0">Team A</p>
                        </td>
                        <td style={{ width: "90px" }}>
                          <div>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted mb-0">Nana Kweku</p>
                        </td>
                        <td>
                          <div>
                            <ul className="list-inline mb-0 font-size-16">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted mb-0">Team B</p>
                        </td>
                        <td>
                          <div>
                            <ul className="list-inline mb-0 font-size-16">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted mb-0">Rey Disse</p>
                        </td>
                        <td>
                          <div>
                            <ul className="list-inline mb-0 font-size-16">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted mb-0">Engineers</p>
                        </td>
                        <td style={{ width: "90px" }}>
                          <div>
                            <ul className="list-inline mb-0 font-size-16">
